...
try {
  ...
  echo "Connection failed"  . $e-getMessage();
    ...
    $sql = "INSERT INTO benutzer (vorname, nachname,geburtsdatum,telefonnummer, steuernummer,kuerzel, wohnort, hausnummer, email,kurs) VALUES ('$vorname', '$nachname','$geburtsdatum','$te', '$email')";
